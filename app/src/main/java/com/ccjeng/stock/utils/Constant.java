...
public class Constant {
    ...
    public final static String ENDPOINT_YAHOO_NEWS = "https://feeds.finance.yahoo.com/rss/2.0/";
    public final static String ENDPOINT_GOOGLE = "http://www.google.com/finance/";
    public final static String ENDPOINT_VETR = "https://vetr-prod.apigee.net/v1/api/";
